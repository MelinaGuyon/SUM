      ...
      if (direction == 'down') {
        Object.keys(that.spritesForms).map(function(objectKey, index) {
          if (Math.abs(that.carousel.y + that.spritesForms[objectKey].y) < 1000) {
            if (that.carouselNumber == 1 && index == 8 || that.carouselNumber == 1 && index == 12 || that.carouselNumber == 1 && index == 32 || that.carouselNumber == 1 && index == 33 || that.carouselNumber == 1 && index == 37 || that.carouselNumber == 1 && index == 36 || that.carouselNumber == 1 && index == 28 || that.carouselNumber == 2 && index == 4 || that.carouselNumber == 2 && index == 5 || that.carouselNumber == 2 && index == 7 || that.carouselNumber == 2 && index == 13 || that.carouselNumber == 3 && index == 3 || that.carouselNumber == 3 && index == 5 || that.carouselNumber == 3 && index == 16 || that.carouselNumber == 3 && index == 9) {
              return
            }
            if (that.carouselNumber == 1 && index == 22 || that.carouselNumber == 1 && index == 11 || that.carouselNumber == 1 && index == 6 || that.carouselNumber == 1 && index == 15 || that.carouselNumber == 1 && index == 13 || that.carouselNumber == 1 && index == 31 || that.carouselNumber == 1 && index == 35 || that.carouselNumber == 1 && index == 34 || that.carouselNumber == 1 && index == 29 || that.carouselNumber == 2 && index == 0 || that.carouselNumber == 2 && index == 8 || that.carouselNumber == 2 && index == 3 || that.carouselNumber == 3 && index == 7 || that.carouselNumber == 3 && index == 11) {
